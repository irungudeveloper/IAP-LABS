 ...
 class User implements Crud, Authenticator{
  ...
  public function getUserId()
    ...
    { 
      ...
      {
        echo "<table align='center' border='1px' class='table table-bordered table-stripped'>";
          echo "<thead>";
              echo "<th col='scope'>"; echo "First Name"; echo "</th>";
              echo "<th col='scope'>"; echo "Last Name"; echo "</th>";
              echo "<th col='scope'>"; echo "City"; echo "</th>";
              echo "<th col='scope'>"; echo "Username"; echo "</th>";
           echo "</thead>";
